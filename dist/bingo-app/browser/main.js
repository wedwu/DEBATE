...
var _AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const moduleImpl = this.moduleImpl ?? import("./chunk-7VD4THJX.js").then((m) => m);
...
var DynamicDelegationRenderer = class {
  ...
  setProperty(el, name2, value) {
    if (this.shouldReplay(name2)) {
      this.replay.push((renderer) => renderer.setProperty(el, name2, value));
    }
...
// src/app/regex.ts
var regex1 = /(?=.*00)(?=.*01)(?=.*02)(?=.*03)(?=.*04)/;
var regex2 = /(?=.*05)(?=.*06)(?=.*07)(?=.*08)(?=.*09)/;
var regex3 = /(?=.*10)(?=.*11)(?=.*12)(?=.*13)(?=.*14)/;
var regex4 = /(?=.*15)(?=.*16)(?=.*17)(?=.*18)(?=.*19)/;
var regex5 = /(?=.*20)(?=.*21)(?=.*22)(?=.*23)(?=.*24)/;
var regex6 = /(?=.*00)(?=.*05)(?=.*10)(?=.*15)(?=.*20)/;
var regex7 = /(?=.*01)(?=.*06)(?=.*11)(?=.*16)(?=.*21)/;
var regex8 = /(?=.*02)(?=.*07)(?=.*12)(?=.*17)(?=.*22)/;
var regex9 = /(?=.*03)(?=.*08)(?=.*13)(?=.*18)(?=.*23)/;
var regex10 = /(?=.*04)(?=.*09)(?=.*14)(?=.*19)(?=.*24)/;
var regex11 = /(?=.*00)(?=.*06)(?=.*12)(?=.*18)(?=.*24)/;
var regex12 = /(?=.*04)(?=.*08)(?=.*12)(?=.*16)(?=.*20)/;

// src/app/election.json
var election_default = [
...
function AppComponent_div_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function AppComponent_div_3_Template_div_click_0_listener() {
      ...
      const n_r3 = ctx_r1.$implicit;
      const i_r4 = ctx_r1.index;
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.onSelect(n_r3, i_r4));
    });
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(2, _c0, n_r3.selected));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(n_r3.word);
  }
}
var _AppComponent = class _AppComponent {
  constructor() {
    this.title = "bingo-app";
    this.cardDefault = election_default;
    this.cardRandom = [];
    this.count = 25;
    this.selectedIndexNumber = 12;
    this.selectedIndex = [this.selectedIndexNumber];
    this.FREESQUARE = "FREE SQUARE";
    this.BINGO = "";
    this.getRandomUniqueItems = (arr, count) => {
      let result = [];
      let used = {};
    ...
    this.onSelect = (n, i) => {
      if (n.word === this.FREESQUARE)
        return;
      this.cardRandom = this.cardRandom.map((word) => {
        if (word.word === n.word) {
    ...
    this.showBingo = (i) => {
      let res = localStorage.getItem("selectedIndex");
      res = JSON.parse(res);
      this.popIfExists(res, i);
    };
    this.popIfExists = (arr, number) => {
      let newNumber = number;
      newNumber = import_lodash.default.padStart(newNumber.toString(), 2, "0");
      const index = arr.indexOf(newNumber);
      index !== -1 ? arr.splice(index, 1) : arr.push(newNumber);
      const sortedValues = arr.toSorted((a, b) => a - b);
      localStorage.setItem("selectedIndex", JSON.stringify(sortedValues));
      this.BINGO = this.containsBingo(sortedValues) ? "BINGO" : "";
    };
    this.containsBingo = (arr) => {
      const arrString = arr.join(" ");
      if (regex1.test(arrString) || regex2.test(arrString) || regex3.test(arrString) || regex4.test(arrString) || regex5.test(arrString) || regex6.test(arrString) || regex7.test(arrString) || regex8.test(arrString) || regex9.test(arrString) || regex10.test(arrString) || regex11.test(arrString) || regex12.test(arrString)) {
        return true;
      }
      return false;
    };
...
_AppComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 10, vars: 2, consts: [[1, "main"], [1, "content"], [1, "flex-container"], ["class", "squares", 3, "ngClass", "click", 4, "ngFor", "ngForOf"], [1, "bingo"], [1, "btn", 3, "click"], [1, "squares", 3, "click", "ngClass"]], template: function AppComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "main", 0)(1, "div", 1)(2, "div", 2);
    \u0275\u0275template(3, AppComponent_div_3_Template, 3, 4, "div", 3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 2)(5, "h1", 4);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    \u0275\u0275advance(3);
    \u0275\u0275property("ngForOf", ctx.cardRandom);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx.BINGO);
  }
}, dependencies: [CommonModule, NgClass, NgForOf, RouterOutlet], styles: ['\n\n.flex-container[_ngcontent-%COMP%] {\n  display: flex;\n  flex-flow: row wrap;\n  justify-content: space-around;\n  flex-direction: row;\n  flex-wrap: wrap;\n  align-items: center;\n  width: 800px;\n  margin: 0 auto;\n}\n.flex-container[_ngcontent-%COMP%]   .bingo[_ngcontent-%COMP%] {\n  color: white;\n  font-weight: bolder;\n  position: absolute;\n  top: 40%;\n  font-size: 21rem;\n  text-shadow: 10px 7px 11px #0d1428;\n  animation-name: _ngcontent-%COMP%_spin;\n  animation-duration: 5000ms;\n  animation-iteration-count: infinite;\n  animation-timing-function: linear;\n}\n@keyframes _ngcontent-%COMP%_spin {\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n}\n.flex-container[_ngcontent-%COMP%]   div[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: row;\n  flex-wrap: wrap;\n  justify-content: space-around;\n  align-items: center;\n}\n.flex-container[_ngcontent-%COMP%]   div.squares[_ngcontent-%COMP%] {\n  width: 150px;\n  height: 150px;\n  color: #4D4D4D;\n  border-radius: 1px;\n  border: 1px solid #000;\n  background-color: #E7E7E7;\n  border-radius: 20px;\n  border: #e6890d solid 4px;\n  box-shadow: 5px 4px 5px 2px rgba(46, 51, 72, 0.6);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-family: "arial-black" !important;\n  padding: 0;\n  font-size: 22px;\n  margin: 5px auto -3px auto;\n  text-align: center;\n  cursor: pointer;\n}\n.flex-container[_ngcontent-%COMP%]   div.squares[_ngcontent-%COMP%]:hover {\n  background: rgba(255, 198, 54, 0.8117647059);\n  box-shadow: 1px 1px 1px 1px rgba(46, 51, 72, 0.6);\n}\n.flex-container[_ngcontent-%COMP%]   div.squares.select[_ngcontent-%COMP%] {\n  background: rgba(255, 198, 54, 0.8117647059);\n  box-shadow: 1px 1px 1px 1px rgba(46, 51, 72, 0.6);\n}\n.flex-container[_ngcontent-%COMP%]   div.squares[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  padding: 20px;\n  word-break: break-word;\n  text-transform: capitalize;\n  font-family: sans-serif !important;\n  font-weight: bolder !important;\n}\n.flex-container[_ngcontent-%COMP%]   button[_ngcontent-%COMP%] {\n  margin-top: 20px;\n  background: rebeccapurple;\n  color: white;\n  padding: 10px;\n  border: 0;\n}\n.flex-container[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]:hover {\n  cursor: pointer;\n}\n/*# sourceMappingURL=app.component.css.map */'] });
